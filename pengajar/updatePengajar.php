...
if ($op == "edit") {
  $id = $_GET['id'];
  $selectTable = "select * from pengajar where id = '$id'";
  $getTable = mysqli_query($database, $selectTable);
  $fetch = mysqli_fetch_array($getTable);
  $idPengajar = $fetch['idPengajar'];
  $namaPengajar = $fetch['namaPengajar'];
  $telepon = $fetch['telepon'];
...
if (isset($_POST["simpan"])) {
  ...
  if ($idPengajar && $namaPengajar && $telepon) {
    $selectTable = "update pengajar set idPengajar='$idPengajar', namaPengajar='$namaPengajar', telepon='$telepon' where id ='$id'";
    $getTable = mysqli_query($database, $selectTable);
...
<body>
  ...
  <div class="container">
    <form action="" method="POST" autocomplete="off">
      ...
      <button type="submit" name="simpan" id="submit"> Update Data Pengajar </button>
